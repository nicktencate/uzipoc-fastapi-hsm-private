...
def certgen(name, asn1publickey, signature_alg):
    ...
    publickey_tohash = asn1publickey.dump() if asn1publickey['algorithm']['algorithm'].native == 'rsa' else asn1publickey['public_key'].native
    newcertcontent = {
        'version': 'v3',
        ...
        'extensions': [{'extn_id': 'key_identifier',
                       ...
                       {'extn_id': 'authority_key_identifier',
                        'critical': False,
                        'extn_value': {'key_identifier': hashlib.sha1(publickey_tohash).digest(),
